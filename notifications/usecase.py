...
class NotificationUseCase:
    ...
    def notify_add_member_to_project(user, project):
        ...
        """
        url = reverse('projects:project-detail', kwargs={'project_id': project.id})
    ...
    def notify_assign_us(user, user_story):
        ...
        url = reverse('projects:project-backlog-detail', kwargs={'project_id': project.id, 'us_id': user_story.id})
    ...
    def notify_add_member_to_sprint(sprint_member):
        ...
        url = reverse('projects:sprints:detail', kwargs={'project_id': project.id, 'sprint_id': sprint.id})
